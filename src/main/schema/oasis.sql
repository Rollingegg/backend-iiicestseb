...
CREATE TABLE term
(
id   INT AUTO_INCREMENT PRIMARY KEY comment '受控标引id',
name varchar(30) comment '受控标引名'
...
(
id                  int auto_increment primary key comment '参考文献表',
